    ...
    const saveClickHandler = (event : React.SyntheticEvent<any>) => {
        ...
        createPatientCallback({
           ...
           // console.log(res.data)
            ...
            alert("Enter correct credentials before proceeding")
         })
    
    }
    let trueName = patientState.name.trim() !== '';
    let validatedName = !trueName ;
    let trueGender = patientState.gender  !== "n";
    let truePlace = patientState.place.trim() !== '';
    let pobValidated = !truePlace ;
    let truebg = patientState.bloodGroup !== "n";
                    ...
                    <div className="card-body">
                        <div className="form-body">
                            <form onSubmit={submitHandler}>
                                ...
                                { validatedName && <p className="alert alert-danger">This is a mandatory field</p>}
                            </form>
                        </div>
                        {/* DOB */}
                        ...
                        <div className="form-group">
                            ...
                            { !trueGender && <p className="alert alert-danger">This is a mandatory field</p>}
                        </div>
                        {/* place of Birth */}
                        <div className="form-group">
                            ...
                            {pobValidated && <p className="alert alert-danger">This is a mandatory field</p>}
                        </div>
                        <div className="form-group">
                            ...
                            { !truebg && <p className="alert alert-danger">This is a mandatory field</p>}
                        </div>
                        <div className="form-group">
